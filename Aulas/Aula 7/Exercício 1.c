...
// O programa realiza uma busca linear em um vetor de inteiros gerado aleatoriamente. 
// Ele permite ao usuário buscar números no vetor e exibe a posição do primeiro número correspondente (ou diz que não foi encontrado).
// A busca continua até o usuário digitar -1.
